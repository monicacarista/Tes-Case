...
WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Name_name'), '')

WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Price_price'), '50000')

WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/textarea_Description_description'), 'tes')

WebUI.click(findTestObject('Page_Tokobuah Admin - Products/input_Description_btn'))

WebUI.uploadFile(findTestObject('Page_Tokobuah Admin - Products/input_Photo_image'), 'E:\\Kobe.jpg')

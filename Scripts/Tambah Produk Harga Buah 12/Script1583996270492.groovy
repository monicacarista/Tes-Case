...
WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Name_name'), 'anggur')

WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Price_price'), '111111111111')
